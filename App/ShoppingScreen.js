                    ...
                    <View style={{flex: 1,flexDirection:'row',alignItems:'center'}}>
                            ...
                            <View style={{marginLeft:8,width: 170,height: 170,borderRadius:10}}>
                                ...
                                >
                                    ...
                                    <View style={{margin:10}}>
                                        ...
                                        <Image source={require('../../QuikieApps/images/starbucks-logo.png')} style={{width: 40,height: 40,margin:10}}/>
                                    </View>
                                <View style={{width: 100,height: 120,position:'absolute',bottom:-3}}>
                                <Image source={require('../../QuikieApps/images/coffee.png')} style={{width: 100,height: 120,overflow:'hidden'}}/>
                                </View>
                                </LinearGradient>
                          </View>
                            <View style={{width: 170,height: 170,borderRadius:10}}>
                                <Image source={require('../../QuikieApps/images/adidas.png')} style={{width: 175,height: 175,marginTop:10,marginLeft:4}}/>
                            </View>
                        ...
                        <Col style={{height: Height,width: Width*0.5,padding:10}}>
                            <View style={{width: 170,height: 250,borderRadius:10}}>
                                <Image source={require('../../QuikieApps/images/apple.png')} style={{width: 175,height: 250,marginLeft:4,borderRadius:10}}/>
                            </View>
                            <View style={{width: 170,height: 250,borderRadius:10,padding:3}}>
                                <Image source={require('../../QuikieApps/images/spotify.png')} style={{width: 175,height: 250,marginLeft:4,borderRadius:10}}/>
                            </View>
                        </Col>
                    </View>
                </ScrollView>
